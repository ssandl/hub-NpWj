"""
CrossEncoder 训练脚本（交互型文本匹配）- LCQMC 数据集
...
def main():
    ...
    # ── 训练循环 ──────────────────────────────────────────────────────────
    ckpt_path   = CKPT_DIR / "crossencoder_lcqmc_best.pt"
    best_val_f1 = 0.0
    log_records = []
    ...
    # ── 训练完成，保存日志 ────────────────────────────────────────────────
    log_path = LOG_DIR / "crossencoder_lcqmc_log.json"
...
def parse_args():
    parser = argparse.ArgumentParser(description="CrossEncoder 训练（交互型文本匹配）- LCQMC 数据集")
